 ...
 * Classes
 */
class OnePageWebsiteRegular extends Module
{
    /**
     * @var
     */
    ...
    protected function compile()
    {
        ...
        $onePageWebsite = new OnePageWebsite();
        $onePageWebsite
        ...
        #fix 4:
        $this->Template->items = $onePageWebsite->generatePage($startPage, $level, $this->opw_template);
    }
}
